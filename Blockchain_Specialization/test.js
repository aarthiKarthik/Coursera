    ...
    ***********/
	...
	return auctionInstance.winners.sendTransaction(0, {from: accounts[0]})
      ...
      ***********/
      ...
      //assert.notEqual( "0", result, "Winner address is not the default addr")
      /**********
      TASK 16: call winners function from accounts[0] to get the winner of item id 1
      ***********/
      return auctionInstance.winners.sendTransaction(1, {from: accounts[0]})
    }).then(function(result) {
      /**********
      ...
      ***********/
      assert.notEqual(result, "0x0000000000000000000000000000000000000000", "Winner address is not the default addr")
      //assert.notEqual(result, "0", "Winner address is not the default addr")
      /**********
      TASK 18: Call winners function from account 3 to get the winner of item id 2
      ***********/
      return auctionInstance.winners.sendTransaction(2, {from: accounts[3]})
    }).then(function(result) {
      /**********
